        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Person_DOB = table.Column<DateTimeOffset>(nullable: true),
                    Designation = table.Column<string>(nullable: false),
                    DOJ = table.Column<DateTimeOffset>(nullable: false),
                    ...
                    LastDateOfEmployment = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerOfficialId = table.Column<int>(nullable: false),
                    EnquiryItemId = table.Column<int>(nullable: false),
                    ForwardedOn = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskDate = table.Column<DateTimeOffset>(nullable: false),
                    CompleteBy = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpDesiredInYrsMin = table.Column<int>(nullable: false),
                    ExpDesiredInYrsMax = table.Column<int>(nullable: false),
                    JobDescInBrief = table.Column<string>(nullable: true),
                    JobDescAttachment = table.Column<string>(nullable: true),
                    SalaryRangeMin = table.Column<int>(nullable: false),
                    SalaryRangeMax = table.Column<int>(nullable: false),
                    ContractPeriodInMonths = table.Column<int>(nullable: false),
                    Food = table.Column<string>(nullable: false),
                    Housing = table.Column<string>(nullable: false),
                    Transport = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EnquiryItems_JobDescriptions_JobDescId1",
                        column: x => x.JobDescId1,
                        principalTable: "JobDescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EnquiryItems_Remunerations_RemunerationId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssessedOn = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmittedByHRExecOn = table.Column<DateTimeOffset>(nullable: false),
                    ...
                    ReviewedByHRSupOn = table.Column<DateTimeOffset>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnquiryForwards_EnquiryItemId",
                table: "EnquiryForwards",
                column: "EnquiryItemId");
